                    ...
                    <div class="izquierda">
                        ...
                        <form action="" method="">
                            ...
                            <div class="formadd">
                                ...
                                <div class="campocolumna">Hora de observación: <input type="time" name="hora" class="info-input-addR"><a href="anadirav.jsp"><button class="avrmen"><img src="recursos/adave b.png" alt="Anadir" class="iconoopc"></button></a></div>
