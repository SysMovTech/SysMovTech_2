                    ...
                    <div class="izquierda">
                        ...
                        <form action="" method="">
                            ...
                            <div class="formadd">
                                ...
                                <div class="subtitulo">Observaciones <input type="text" name="nombreRep" class="info-input-addF"></div>
                                ...
                                <div class="botonesEstado">
                                    ...
                                    <button type="button" class="cancelar" onclick="window.location.href = 'averias.jsp'">Cancelar</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="fila-contenedores-avr">
                <div class="contenedorveravr-print">
                    ...
                    <div class="botones">
                        ...
                        <button class="cancelar" onclick="window.location.href = 'averias.jsp'">Cancelar</button>
                    </div>                        
                </div>
            </div>
        </div>`;
                ...
                const button4Wrapper = document.getElementById('button4Wrapper');
                button4Wrapper.addEventListener('click', () => {
                    modalContent.innerHTML = `
        <div class="contenedor-scroll-avr-resuelto">
            <div class="contenedor-mod-resuelto">
                <h1>Avería Resuelta</h1>
                <p>Por favor confirma que esta avería ha sido resuelta. Detalles:</p>
                <ul>
                    <li>Descripción: Breve descripción de la avería resuelta</li>
                    <li>Fecha de resolución: <input type="date"></li>
                    <li>Observaciones: <textarea rows="4"></textarea></li>
                </ul>
