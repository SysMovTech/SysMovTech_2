...
<html>
    <head>
        ...
        <link rel="stylesheet" href="estilos/formadd.css"/>
    </head>
    <script>
...
`;
        ...
        <!---<script>
            ...
            function crearModal() {
                ...
                if (modalExistente)
                    return; // Si ya existe, no lo recreamos
    ...
    `;
        ...
        `;
                ...
                // Agregar evento para cerrar modal cuando se haga clic afuera
                modal.addEventListener('click', (e) => {
                    if (e.target === modal) {
                        cerrarModal();
                    }
...
// Evento que escucha el mensaje del iframe para cerrar el modal
...
// Evento para abrir el modal al hacer clic en el botón de activación
            contenedorVerAvr.addEventListener('click', () => {
                crearModal();
            });
        </script>-->
        ...
        <script>
            ...
            function crearModal() {
                let modalExistente = document.getElementById('modal');
                if (modalExistente) {
                    modalExistente.remove(); // Eliminar el modal si ya existe para evitar duplicados
                }
