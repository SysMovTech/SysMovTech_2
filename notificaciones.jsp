...
<html>
                    ...
                    <div class="contenedor-scroll-avr-ver">
                        <div class="fila-contenedores-avr">
                            <div class="contenedorveravr-ver">
                                <h3 style="text-align: center;">Al accesar al sistema por primera vez, <br>es necesario que cambies tu contraseña</h3>
                                <div class="formadd">
                                    <input type="text" name="contrasena" class="info-input" placeholder="Nueva contraseña">
                                    <input type="text" name="contrasena" class="info-input" placeholder="Confirmar contraseña">
                                </div>
                                <div class="botones">
                                    <button class="confirmar" id="closeModal">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="inicioModal" class="modal" style="display: none;">
        <div class="modal-content">
        </div>
    </div>
